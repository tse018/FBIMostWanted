...
export default [
      ...
      // when user pick the first option Select a Category from drop down, will end up on empty path /wanted/category/,
      ...
      // everything else will go to this page not found
